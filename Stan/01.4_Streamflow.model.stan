//This model is optimized using vectorization and the fast fourier transform.
//This model is similar to 01, but estimates a scaling coefficient for each time step.
data {
...
transformed parameters{
  ...
  complex_vector[N] inv_fft_product = inv_fft(elt_multiply(fft(IRF),fft(elt_multiply(R,beta))));
